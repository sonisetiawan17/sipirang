...
@section('content')
    ...
    @endif
    <form action="{{ route('superadmin.simpanPermohonan') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="col-xl-12">
                                <div class="panel-body panel-form">
                                    <form class="form-horizontal form-bordered">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-lg-4 col-form-label">Pemohon <sup
                                                    class="text-red">*</sup></label>
                                            <div class="col-lg-8">
                                                <select class="form-input w-full text-small" name="user_id">
                                                    ...
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}" 
                                                            ...
                                                            data-alamat="{{ $user->alamat }}">{{ $user->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-input text-small"
                                                    name="nik" id="nik" value="" disabled />
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-lg-8">
                                                ...
                                                <input type="text" class="form-control form-input text-small"
                                                    value="" name="name" id="name" disabled />
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-input text-small"
                                                    name="no_telp" id="no_telp" value="" disabled />
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-lg-8">
                                                <input type="text" class="form-control form-input text-small"
                                                    name="alamat" value="" id="alamat" disabled />
                                            </div>
                                        </div>
                                </div>
                            </div>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var selectUser = document.querySelector('select[name="user_id"]');
            var nikInput = document.getElementById('nik');
            var nameInput = document.getElementById('name');
            var telpInput = document.getElementById('no_telp');
            var alamatInput = document.getElementById('alamat');

            selectUser.addEventListener('change', function() {
                var selectedUser = this.options[this.selectedIndex];

                nikInput.value = selectedUser.dataset.nik;
                nameInput.value = selectedUser.dataset.name;
                telpInput.value = selectedUser.dataset.no_telp;
                alamatInput.value = selectedUser.dataset.alamat;
            });
        });
    </script>
@endpush
