                        ...
                        <tbody>
                            ...
                            @foreach ($users as $i)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('admin.lihat_users', $i->id) }}" type="button" class="btn btn-white"><i
                                            ...
                                            <form action="{{ route('admin.hapus_users', $i->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body mx-3" id="tampil_modal">
                    <form method="post" action="{{ route('admin.ubah_users') }}">
                        @csrf
